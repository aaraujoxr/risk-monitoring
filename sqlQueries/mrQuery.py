mr_query_string = """
  SELECT timestamp, chain_id, margin_engine, owner, tick_lower, tick_upper, tick, position_margin, fixed_token_balance, variable_token_balance, initial_margin_requirement, liquidation_margin_requirement
  FROM (
